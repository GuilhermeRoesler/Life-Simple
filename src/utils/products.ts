...
export const initialProducts: Product[] = [
  ...
  // Cabelo - 8 produtos
  {
    ...
    nome: "Hair Vitamins",
    categoria: "Cabelo",
    descricao_curta: "Vitaminas para crescimento capilar.",
    descricao_longa: "Complexo vitamínico com biotina, cistina e zinco para fortalecimento dos fios. Vitaminas do complexo B.",
    preco: "74.90",
    imagem: "img/vitaminas-cabelo.png"
  },
  {
    id: "m-cabelo-02",
    nome: "Colágeno Capilar",
    categoria: "Cabelo",
    descricao_curta: "Colágeno específico para cabelos.",
    descricao_longa: "Colágeno hidrolisado tipo I com minerais para elasticidade e brilho. Silício orgânico e enxofre.",
    preco: "89.90",
    imagem: "img/colageno-capilar.png"
  },
  {
    id: "m-cabelo-03",
    nome: "Anti-Queda Max",
    categoria: "Cabelo",
    descricao_curta: "Tratamento anti-queda intensivo.",
    descricao_longa: "Fórmula com serenoa repens, finasterida vegetal e aminoácidos. Reduz DHT e fortalece raiz.",
    preco: "119.90",
    imagem: "img/anti-queda.png"
  },
  {
    id: "m-cabelo-04",
    nome: "Keratin Plus",
    categoria: "Cabelo",
    descricao_curta: "Queratina hidrolisada para reconstrução.",
    descricao_longa: "Queratina pura para reconstrução da estrutura capilar. Aminoácidos essenciais e peptídeos.",
    preco: "94.90",
    imagem: "img/queratina.png"
  },
  {
    id: "m-cabelo-05",
    nome: "Grow Formula",
    categoria: "Cabelo",
    descricao_curta: "Acelerador de crescimento capilar.",
    descricao_longa: "Estimula crescimento com metilsulfonilmetano, biotina e ácido fólico. Melhora circulação do couro cabeludo.",
    preco: "84.90",
    imagem: "img/crescimento-capilar.png"
  },
  {
    id: "m-cabelo-06",
    nome: "Shine Complex",
    categoria: "Cabelo",
    descricao_curta: "Brilho e maciez natural.",
    descricao_longa: "Óleo de argan, vitamina E e ômegas para cabelos sedosos e brilhantes. Hidratação profunda.",
    preco: "69.90",
    imagem: "img/brilho-cabelo.png"
  },
  {
    id: "m-cabelo-07",
    nome: "Capilar Detox",
    categoria: "Cabelo",
    descricao_curta: "Detoxificação do couro cabeludo.",
    descricao_longa: "Remove resíduos e toxinas do couro cabeludo. Chá verde, bardana e cavalinha.",
    preco: "59.90",
    imagem: "img/detox-capilar.png"
  },
  {
    id: "m-cabelo-08",
    nome: "Repair Intensive",
    categoria: "Cabelo",
    descricao_curta: "Reparação intensiva para cabelos danificados.",
    descricao_longa: "Recupera cabelos químicamente tratados. Ceramidas, proteínas e lipídeos reconstrutores.",
    preco: "104.90",
    imagem: "img/reparacao-cabelo.png"
  },
